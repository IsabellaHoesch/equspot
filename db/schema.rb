...
ActiveRecord::Schema.define(version: 2021_06_09_133659) do
  ...
  create_table "chatroom_visits", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "chatroom_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["chatroom_id"], name: "index_chatroom_visits_on_chatroom_id"
    t.index ["user_id"], name: "index_chatroom_visits_on_user_id"
  end
  ...
  add_foreign_key "chatroom_visits", "chatrooms"
  add_foreign_key "chatroom_visits", "users"
